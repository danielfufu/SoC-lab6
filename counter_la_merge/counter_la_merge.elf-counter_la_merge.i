# 0 "counter_la_merge.c"
# 1 "/home/ubuntu/lab-wlos_baseline/testbench/counter_la_merge//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_merge.c"
# 19 "counter_la_merge.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 20 "counter_la_merge.c" 2
# 1 "../../firmware/user_uart.h" 1
# 21 "counter_la_merge.c" 2
# 1 "../../firmware/stub.c" 1
# 18 "../../firmware/stub.c"
void putchar(char c)
{
...
# 47 "counter_la_merge.c"
void main()
{

    int mask;
# 78 "counter_la_merge.c"
...
# 146 "counter_la_merge.c"
 int* tmp_mm = matmul();

 (*(volatile uint32_t*)0x2600000c) = *tmp_mm << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+12) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+13) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+14) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_mm+15) << 16;


 (*(volatile uint32_t*)0x2600000c) = 0xAB210000;



 (*(volatile uint32_t*)0x2600000c) = 0xAB220000;

 int* tmp_qs = qsort();
 (*(volatile uint32_t*)0x2600000c) = *tmp_qs << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+9) << 16;


 (*(volatile uint32_t*)0x2600000c) = 0xAB230000;


 (*(volatile uint32_t*)0x2600000c) = 0xAB240000;

 int* tmp_fir = fir();

 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+10) << 16;
# 196 "counter_la_merge.c"
